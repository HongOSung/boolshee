...
public class EgovWebServletContextListener implements ServletContextListener {
    ...
    public void contextDestroyed(ServletContextEvent event) {
    	if(System.getProperty("spring.profiles.active") != null){
    		System.setProperty("spring.profiles.active", "");//System.setProperty("spring.profiles.active", null);
    		//System.err.println("===========444=== System.getProperty(\"spring.profiles.active\")=="+System.getProperty("spring.profiles.active"));
    	}
    } 
