...
public interface EgovUserManageService  {
	...
	public void updateLockIncorrect(UserManageVO userManageVO) throws Exception;
		...
		/**
	 * 입력한 사용자패스워드의 존재여부를 체크하여 사용가능여부를 확인
	 * @param checkPwd 존재여부 확인대상 패스워드
	 * @return 사용가능여부(패스워드 사용회수 int)
	 * @throws Exception
	 */
	public int checkPwdDplct(String checkPwd) throws Exception;
	
	public int checkIdDplct_BbsMber(String mbId_bsNm) throws Exception;
	
	public int checkIdDplct_BbsMberHp(String mbId_bsNm) throws Exception;

	public int checkIdDplct_BbsMberNt(String mbId_bsNm) throws Exception;
	
	public int checkIdDplct_noMbid(String no_mbId) throws Exception;

	public int checkIdGepyosoResponse_noMbid(String no_mbId) throws Exception;

	public int checkIdSajeonTupyosoResponse_noMbid(String no_mbId) throws Exception;

	public int checkIdDplct_pollWatch(String no_mbId) throws Exception;
	
	public int EgovBBSMasterDpKeyCnfirmAjax(String no_mbId) throws Exception;

	public int checkIdDplct_pollWatchHp(String no_mbId) throws Exception;

	public int checkIdDplct_pollWatchNt(String bbsNm) throws Exception;

	/**
	 * 입력한 추천자자아이디의 존재여부를 체크하여 사용가능여부를 확인
	 * @param checkId 존재여부 확인대상 아이디
	 * @return 사용가능여부(아이디 사용회수 int)
	 * @throws Exception
	 */
