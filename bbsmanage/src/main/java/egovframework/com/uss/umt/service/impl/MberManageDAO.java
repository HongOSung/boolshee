...
public class MberManageDAO extends EgovComAbstractDAO{
	...
	public List<MberManageVO> selectMyMberList(UserDefaultVO userSearchVO){
        return (List<MberManageVO>) list("mberManageDAO.selectMyMberList", userSearchVO);
    }
    ...
    public int selectMyMberListTotCnt(UserDefaultVO userSearchVO) {
        return (Integer)selectOne("mberManageDAO.selectMyMberListTotCnt", userSearchVO);
    }
    ...
    public void deleteGnrMber(UserDefaultVO userSearchVO){
        delete("mberManageDAO.deleteGnrMber", userSearchVO);
    }
    
    public void deleteMberHp(String mberId){
        delete("mberManageDAO.deleteMber_SHp", mberId);
    }
	...
	public String insertCOMTNGNRLMBER(MberManageVO mberManageVO) {
	...
	public String insertGepyosoResponse(MberManageVO mberManageVO) {
		return String.valueOf((int)insert("mberManageDAO.insertGepyosoResponse", mberManageVO));
	}
	
	public String insertMnaResponse(MberManageVO mberManageVO) {
		return String.valueOf((int)insert("mberManageDAO.insertMnaResponse", mberManageVO));
	}
	
	public String insertSajeonResponse(MberManageVO mberManageVO) {
		return String.valueOf((int)insert("mberManageDAO.insertSajeonResponse", mberManageVO));
	}
	...
	public MberManageVO selectMberHp(String mberId) {
		return (MberManageVO) selectOne("mberManageDAO.selectMber_SHp", mberId);
	}
    ...
    public void updatePasswordHp(MberManageVO mberManageVO) {
    	update("mberManageDAO.updatePassword_SHp", mberManageVO);
	}
    ...
    public MberManageVO selectPasswordHp(MberManageVO mberManageVO){
    	return (MberManageVO) selectOne("mberManageDAO.selectPassword_SHp", mberManageVO);
    }
