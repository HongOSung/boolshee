...
public class EgovUserManageServiceImpl extends EgovAbstractServiceImpl implements EgovUserManageService {
	...
	public int checkIdDplct_BbsMberHp(String mbId_bsNm) {
		return userManageDAO.checkIdDplct_BbsMberHp(mbId_bsNm);
	}
	
	@Override
	public int checkIdDplct_BbsMberNt(String mbId_bsNm) {
		return userManageDAO.checkIdDplct_BbsMberNt(mbId_bsNm);
	}


	@Override
	public int checkIdDplct_BbsMber(String mbId_bsNm) {
		return userManageDAO.checkIdDplct_BbsMber(mbId_bsNm);
	}
	
	/**
	 * 입력한 사용자아이디와 선거구 중복여부를 체크하여 사용가능여부를 확인
	 * @param no_mbId 중복여부 확인대상 아이디
	 * @return 사용가능여부(아이디 사용회수 int)
	 * @throws Exception
	 */
	@Override
	public int checkIdDplct_noMbid(String no_mbId) {
		return userManageDAO.checkIdDplct_noMbid(no_mbId);
	}
	
	@Override
	public int checkIdGepyosoResponse_noMbid(String no_mbId) {
		return userManageDAO.checkIdGepyosoResponse_noMbid(no_mbId);
	}
	
	@Override
	public int checkIdSajeonTupyosoResponse_noMbid(String no_mbId) {
		return userManageDAO.checkIdSajeonTupyosoResponse_noMbid(no_mbId);
	}
	
	/**
	 * 입력한 사용자아이디와 투표소 중복여부를 체크하여 사용가능여부를 확인
	 * @param no_mbId 중복여부 확인대상 아이디
	 * @return 사용가능여부(아이디 사용회수 int)
	 * @throws Exception
	 */
	...
	public int checkIdDplct_pollWatch(String no_mbId) {
		return userManageDAO.checkIdDplct_pollWatch(no_mbId);
	}
	
	@Override
	public int EgovBBSMasterDpKeyCnfirmAjax(String no_mbId) {
		return userManageDAO.EgovBBSMasterDpKeyCnfirmAjax(no_mbId);
	}
	
	/**
	 * 입력한 사용자아이디와 도움요청 중복여부를 체크하여 사용가능여부를 확인
	 * @param no_mbId 중복여부 확인대상 아이디
	 * @return 사용가능여부(아이디 사용회수 int)
	 * @throws Exception
	 */
	...
	public int checkIdDplct_pollWatchHp(String bbsNm) {
		return userManageDAO.checkIdDplct_pollWatchHp(bbsNm);
	}
	@Override
	public int checkIdDplct_pollWatchNt(String bbsNm) {
		return userManageDAO.checkIdDplct_pollWatchNt(bbsNm);
	}
	...
	public int checkPwdDplct(String checkPwd) {
		return userManageDAO.checkPwdDplct(checkPwd);
	}

	@Override
	public int checkRecommenderIdCnfirm(String checkId) throws Exception {
		return userManageDAO.checkRecommenderIdCnfirm(checkId);
	}
