...
public class EgovLoginServiceImpl extends EgovAbstractServiceImpl implements EgovLoginService {
	...
	public LoginVO actionLogin(LoginVO vo) throws Exception {
    	...
    	// 1. 입력한 비밀번호를 암호화한다.
    	//암호화 하기전 비번
    	//System.err.println("=========uat/uia=====암호화 하기전 비번="+vo.getPassword());
		String enpassword = EgovFileScrty.encryptPassword(vo.getPassword(), vo.getId());
    	vo.setPassword(enpassword);
    	//System.err.println("=======uat/uia=======암호화 한 후 비번 enpassword="+enpassword);
	 ...
	 */
    @Override
	public LoginVO searchPassword1(LoginVO vo) throws Exception {

    	//boolean result = true;

    	// 1. 아이디, 이름, 이메일주소, 비밀번호 힌트, 비밀번호 정답이 DB와 일치하는 사용자 Password를 조회한다.
    	LoginVO loginVO = loginDAO.searchPassword(vo);
    	////System.err.println("=============loginVO================"+loginVO.getPassword());
    	if (loginVO == null || loginVO.getPassword() == null || "".equals(loginVO.getPassword())) {
    		//return false;
    		return loginVO;
    	}
    	////System.err.println("=============loginVO======22=========="+loginVO.getPassword());
    	...
    	////System.err.println("=============loginVO=====33==========="+loginVO.getPassword());
    	// 3. 임시 비밀번호를 암호화하여 DB에 저장한다.
    	LoginVO pwVO = new LoginVO();
		String enpassword = EgovFileScrty.encryptPassword(newpassword, vo.getId());
    	pwVO.setId(vo.getId());
    	pwVO.setPassword(enpassword);
    	pwVO.setNewPassword(newpassword);/////////////////////////
    	pwVO.setUserSe(vo.getUserSe());
    	loginDAO.updatePassword(pwVO);
    	////System.err.println("=============loginVO=========44======="+pwVO.getNewPassword());
    	...
    	//result = sndngMailRegistService.insertSndngMail(sndngMailVO);// 당분간 이메일 발송 연기20210830 홍오성
    	String result_S =sndngMailVO.getEmailCn();
    	//("고객님의 임시 비밀번호는 " + newpassword + " 입니다.");
    	////System.err.println("=============loginVO=========55======="+("고객님의 임시 비밀번호는 " + newpassword + " 입니다."));
    	////System.err.println("=============loginVO=========66======="+("고객님의 임시 비밀번호는 " + pwVO.getNewPassword() + " 입니다."));
	 ...
	 * @return boolean
	 * @exception Exception
	 * 당분간 메일서버가 제대로 가동할 때까지는 보류함 20210830 홍오성
	 */
    @Override
	public boolean searchPassword(LoginVO vo) throws Exception {
    	...
    	pwVO.setUserSe(vo.getUserSe());
    	loginDAO.updatePassword(pwVO);
    	////System.err.println("=============loginVO=========44======="+loginVO.getPassword());
