...
<!-- 상단타이틀  /cop/bbs/updateBBSMaster.do -->
 ...
 <div id="wTableFrm">
	<h2>${pageTitle} <spring:message code="title.updateWatchdog" />
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/cop/bbs/selectMnaListInfs.do' /><c:if test='${boardMasterVO.no != null}'>?cmmntyId=${boardMasterVO.no}</c:if>"><spring:message code="button.districtList" /></a></span><!-- 목록 -->
