...
<div id="board">
		...
		<ul>
			<li>
				<select name="searchCnd" title="<spring:message code="title.searchCondition" /> <spring:message code="input.cSelect" />">
					...
					<option value="2"  <c:if test="${searchVO.searchCnd == '2'}">selected="selected"</c:if> ><spring:message code="comCopBbs.boardMasterVO.list.mnaNm" /></option><!-- 정당 -->				
				</select>
			</li>
			<!-- 검색키워드 및 조회버튼 -->
			<li>
	...
	<tr>
		...
		<th><spring:message code="table.mnaNm" /></th><!-- 이름(한자)-->			
	</tr>
	</thead>
	<tbody class="ov">
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/cop/bbs/updateMnaView.do?no=${resultInfo.no}'/>" 
