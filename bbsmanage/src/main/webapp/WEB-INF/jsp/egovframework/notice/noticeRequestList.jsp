...
function fn_egov_select_linkPage(pageNo){
	...
	document.BBSMasterForm.action = "<c:url value='/cop/bbs/selecthelpRequestInfsNt.do'/>";
...
<br>
<form name="BBSMasterForm" action="<c:url value='/cop/bbs/selecthelpRequestInfsNt.do'/>" method="post" onSubmit="fn_egov_search_bbssj(); return false;"> 
<div id="board">
	<h1><font color="red" size="3em">국회청원</font>, 알림, 행사, 질문 목록</h1><!-- 목록 -->
	<!-- 하단 버튼 -->
	...
	<tr>
		...
		<th class="board_th_link"><spring:message code="comCopBbs.boardMasterVO.list.bbsNm4" /></th><!-- 공지사항명 -->
		<%--<th><spring:message code="table.reger" /></th><!-- 등록자 -->
		<th><spring:message code="table.bssnm4" /></th><!-- 소속단체 --> --%>
		<th><spring:message code="table.noticeRefullNm" /></th><!--공지,행사,질문 총명 -->
		<th><spring:message code="table.notice" /></th><!-- 공지,헹사,질문 내용-->
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/cop/bbs/updateBBSMasterViewNt.do?bbsId=${resultInfo.bbsId}'/>" >
