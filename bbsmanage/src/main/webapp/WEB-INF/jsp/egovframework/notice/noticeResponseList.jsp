...
function fn_egov_select_linkPage(pageNo){
	...
	document.BBSMasterForm.action = "<c:url value='/cop/bbs/selectBbsMemberInfsNt.do'/>";
...
<form name="BBSMasterForm" action="<c:url value='/cop/bbs/selectBbsMemberInfsNt.do'/>" method="post" onSubmit="fn_egov_search_bbssj(); return false;"> 
<div id="board">
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/cop/bbs/updateBBSMasterView2Nt.do?bbsId=${resultInfo.bbsId}&mberId=${resultInfo.mberId}'/>" >	
