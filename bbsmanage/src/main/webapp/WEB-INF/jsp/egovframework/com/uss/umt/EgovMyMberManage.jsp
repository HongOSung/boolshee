...
<form name="listForm" action="<c:url value='/uss/umt/EgovMyMberManage.do'/>" method="post"> 
<div id="board">
		...
		<ul>
			...
			<li><!-- 조건 -->
                <select name="searchCondition" id="searchCondition" title="<spring:message code="comUssUmt.userManageSsearch.searchConditioTitle" />"><!--  -->
                    <option value="0" <c:if test="${mberVO.searchCondition == '0'}">selected="selected"</c:if> ><spring:message code="comUssUmt.userManageSsearch.searchMberId" /></option><!-- 회원ID  --> 
...
<%--		<th><spring:message code="comUssUmt.userManageList.recommender" /></th><!-- 추천자 아이디 --> --%>
	...
	<tr>
	    ...
	    <%--<td><c:out value="${result.recommenderId}"/></td> --%>
