...
<div id="wTableFrm">
	...
	<!-- 추천자아이디 -->
		...
		<tr>
			<th><label for="recommenderId">${title}</label> <span class="pilsu">*</span></th>
			<td class="left">
		...
		<tr>
			<th><label for="mberId">${title}</label><font color='blue'><span class="pilsu">*</span></th>
			<td class="left">
			<button id="btnMbrId" class="btn_s2" onClick="return false;"
				...
				<font color='red'>아이디 중복 방지를 위해</font><font color='blue'>[<b>중복아이디검색</b>]</font>버튼을 먼저 클릭 합니다.
		...
		<tr>
			...
			<td class="left">
                    <form:input path="areaNo" id="areaNo" title="전화번호" cssClass="txaIpUmt" size="5" maxlength="3" style="width:40px;" onkeyup="siche_next()" />
                    - <form:input path="middleTelno" id="middleTelno" cssClass="txaIpUmt" size="5" maxlength="4" style="width:40px;" onkeyup="siche_next2()" />
                    - <form:input path="endTelno" id="endTelno" cssClass="txaIpUmt" size="5" maxlength="4" style="width:40px;" /> 가능한 <font color='red'><b>연락</b></font>이 쉽게 <font color='red'><b>핸드폰 번호</b></font>를 입력합니다.
		...
		<tr>
			...
			<td class="left">
                    ...
                    <button class="btn_s2" onClick="fn_egov_ZipSearch(document.mberManageVO, document.mberManageVO.zip, document.mberManageVO.zip_view, document.mberManageVO.adres);return false;" title="<spring:message code="button.search" /> <spring:message code="input.button" />">우번번호검색</button> 
                    <div><form:errors path="zip" cssClass="error" /></div>  -->
			 우편번호와 <strong>주소</strong>는 나중에 공명선거 운동 시, <strong><font color='red'>투표소</font></strong>와 <strong><font color='red'>선거구</font></strong> 관리에 필요하고,<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>우편번호 검색</strong>은 진행 중입니다.
			 </td>
		</tr>
		<!-- 주소 -->
...
<%--<input type="text" name="telNo" id="telNo" value="<c:out value="${areaNo }+${middleTelno }+${endTelno }"/>" /> --%>
	<!-- 하단 버튼 --> 
	<div class="btn">
