...
<form name="passwordChgVO" method="post" action="<c:url value="/uss/umt/EgovMberPasswordUpdtHp.do"/>" onsubmit="fnUpdate(document.forms[0]); return false;">
...
<div id="wTableFrm">
	...
	<tbody>
		...
		<tr>
			<th>${title}</th>
				<td class="left">
				<input name="mberId" id="mberId" type="text" size="20" value="<c:out value='${mberId}'/>"  maxlength="20" readonly >
