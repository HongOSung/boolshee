...
<html>
<head>
<title><!--${pageTitle}--> 소시민 단체<spring:message code="title.create" /></title><!-- 게시판 마스터 등록 -->
...
<div id="wTableFrm">
	<!-- 타이틀 -->
	<h2><!-- ${pageTitle} -->소시민 단체 <spring:message code="title.create" /></h2><!-- 게시판 마스터 등록 -->
	...
	<tbody>
		...
		<!-- 게시판 소개내용 -->
		<c:set var="title"><spring:message code="comCopBbs.boardMasterVO.regist.action"/> </c:set>
		<tr>
		...
		<c:set var="title"><spring:message code="comCopBbs.boardMasterVO.regist.fullnm"/> </c:set>
		<tr>
		...
		<c:set var="title"><spring:message code="comCopBbs.boardMasterVO.regist.members"/> </c:set>
		<tr>
