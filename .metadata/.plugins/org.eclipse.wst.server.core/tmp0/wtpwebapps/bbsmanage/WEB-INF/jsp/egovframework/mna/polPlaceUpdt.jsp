...
<%@ page import="egovframework.com.cop.bbs.service.BoardMaster" %>
...
<!-- 상단타이틀  /cop/bbs/updateBBSMaster.do -->
 ...
 <div id="wTableFrm">
	<h2>${pageTitle} <spring:message code="title.updatePolPlace" />
	<!-- 수정폼 -->
	...
	<div class="btn">
		...
		<span class="btn_s"><a href="<c:url value='/cop/bbs/insertPolPlaceView.do?no=${boardMasterVO.no}'/>" ><spring:message code="button.Watchdog" /></a></span><!-- 지킴이 등록 -->
