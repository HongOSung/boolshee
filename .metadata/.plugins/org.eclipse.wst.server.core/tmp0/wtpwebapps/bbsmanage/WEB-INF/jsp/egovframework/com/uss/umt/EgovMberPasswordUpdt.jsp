...
function fnUpdate(form){
    if(validatePasswordChgVO(form)){
    	alert(form.newPassword.value);
    	//alert(form.newPassword2.value);
...
<form name="passwordChgVO" method="post" action="<c:url value="/uss/umt/EgovMberManage.do"/>" onsubmit="fnUpdate(document.forms[0]); return false;">
...
<div id="wTableFrm">
	...
	<!-- 하단 버튼 -->
	<div id="btn">
	<input type="submit" class="btn_s" value="<spring:message code="button.update" />" title="<spring:message code="button.update" /> <spring:message code="input.button" />" />
