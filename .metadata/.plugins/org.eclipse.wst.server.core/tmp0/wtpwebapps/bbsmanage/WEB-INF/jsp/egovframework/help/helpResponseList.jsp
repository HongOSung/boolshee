...
function fn_egov_select_linkPage(pageNo){
	...
	document.BBSMasterForm.action = "<c:url value='/cop/bbs/selectBbsMemberInfsHp.do'/>";
...
<form name="BBSMasterForm" action="<c:url value='/cop/bbs/selectBbsMemberInfsHp.do'/>" method="post" onSubmit="fn_egov_search_bbssj(); return false;"> 
<div id="board">
	...
	<tr>
		...
		<th><spring:message code="table.bssnm2" /></th><!-- 도움요청 -->
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/cop/bbs/updateBBSMasterView2Hp.do?bbsId=${resultInfo.bbsId}&mberId=${resultInfo.mberId}'/>" >	
