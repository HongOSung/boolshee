...
<div id="board">
	...
	<tr>
		...
		<th class="board_th_link"><spring:message code="comCopBbs.boardMasterVO.list.bbsNm" /></th><!-- 소시민 단체명 -->
		...
		<th><spring:message code="table.fullnm" /></th><!-- 단체총명 -->
		<th><spring:message code="table.action" /></th><!-- 취지와 실천과제-->
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/cop/bbs/updateBBSMasterView.do?bbsId=${resultInfo.bbsId}'/>" >
		<c:out value='${fn:substring(resultInfo.BBS_NM, 0, 40)}'/></a></td>
		<td class="left"><a href="<c:url value='/cop/bbs/updateBBSMasterView.do?bbsId=${resultInfo.bbsId}'/>" >
		<center><c:out value='${fn:substring(resultInfo.mberNm, 0, 40)}'/></center></a></td>
		<%--<td class="left"><a href="<c:url value='/cop/bbs/updateBBSMasterView.do?bbsId=${resultInfo.bbsId}'/>" >
		<c:out value='${fn:substring(resultInfo.tel, 0, 40)}'/></a></td> --%>
		<td class="left"><a href="<c:url value='/cop/bbs/updateBBSMasterView.do?bbsId=${resultInfo.bbsId}'/>" >
		<center><c:out value='${fn:substring(resultInfo.members, 0, 40)}'/></center></a></td>
		<td class="left"><a href="<c:url value='/cop/bbs/updateBBSMasterView.do?bbsId=${resultInfo.bbsId}'/>" >
		<c:out value='${fn:substring(resultInfo.fullnm, 0, 40)}'/></a></td>	
		<td class="left"><a href="<c:url value='/cop/bbs/updateBBSMasterView.do?bbsId=${resultInfo.bbsId}'/>" >		
		<c:out value='${fn:substring(resultInfo.action, 0, 40)}'/></a></td>
