...
<c:set var="pageTitle"><spring:message code="comCopBbs.boardMasterVO.noticeReqJointitle"/></c:set>
<!DOCTYPE html>
<html>
<head>
...
<form:form commandName="boardMasterVO" action="${pageContext.request.contextPath}/cop/bbs/updateResponseNt.do" method="post" onSubmit="fn_egov_updt_bbs(document.forms[0]); return false;">  
<div id="wTableFrm">
	...
	<tbody>
		...
		<!-- 알림,행사,질문 명  -->
		<c:set var="title"><spring:message code="comCopBbs.boardMasterVO.updt.reNtbbsNm"/> </c:set>
		<tr>
		...
		<%--<!-- 알림,행사,질문 등록자 -->
		<c:set var="title"><spring:message code="comCopBbs.boardMasterVO.updt.NtRequestNm"/> </c:set>
		<tr>
		...
		<%--<c:set var="title"><spring:message code="comCopBbs.boardMasterVO.updt.counts"/> </c:set><!-- 조회수 -->
		<tr>
		...
		<!-- 도움응답내용 --> 
		<c:set var="title"><spring:message code="comCopBbs.boardMasterVO.updt.Ntresponsecontents"/> </c:set>
		<div class="jb-700">
	...
	<div>
		...
		<div class="btn">
			<span class="btn_s"><a href="<c:url value='/cop/bbs/deleteBBSMberNt.do?bbsId=${boardMasterVO.bbsId}'/>"  title="<spring:message code="button.delete" />  <spring:message code="input.button" />"><spring:message code="button.delete" /></a></span><!-- 삭제 -->
			...
			<span class="btn_s"><a href="<c:url value='/cop/bbs/selectBBSMasterInfsNt.do' /><c:if test='${boardMasterVO.cmmntyId != null}'>?cmmntyId=${boardMasterVO.cmmntyId}</c:if>"  title="<spring:message code="button.requestlist" /> <spring:message code="input.button" />"><spring:message code="button.requestlist" /></a></span><!-- 요청목록 -->
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
