...
<form:form commandName="boardMasterVO" action="${pageContext.request.contextPath}/cop/bbs/updateMnaResponse.do" method="post" onSubmit="fn_egov_updt_bbs(document.forms[0]); return false;">  
<br><div id="wTableFrm">
	<h2>[${pageTitle} <spring:message code="title.content" />]</h2><!-- 청원 내용 -->
	<!-- 수정폼 -->
	<br><table class="wTable" summary="<spring:message code="common.summary.update" arguments="${pageTitle}" />">
	...
	<tbody>
		...
		<!-- 청원 명   -->
		<c:set var="title"><spring:message code="comCopBbs.boardMasterVO.updt.mnaRequestBbsNm"/> </c:set>
		<tr>
		...
		<!-- 동의자 -->
		<c:set var="title"><spring:message code="comCopBbs.boardMasterVO.updt.mnaRespnsemember"/> </c:set>
		<tr>
		...
		<!-- 청원 동의 내용 --> 
		<c:set var="title"><spring:message code="comCopBbs.boardMasterVO.updt.MnaResponsecontents"/> </c:set>
		<div class="jb-700">
      		<p><span class="pilsu">[</span><font color="blue"><label for="contents">${title} <span class="pilsu">]</span></label></font> </p>
    	</div>
	...
	<div>
		...
		<div class="btn">
			<span class="btn_s"><a href="<c:url value='/cop/bbs/deleteMnaResponse.do?bbsId=${boardMasterVO.bbsId}'/>"  title="<spring:message code="button.delete" />  <spring:message code="input.button" />"><spring:message code="button.delete" /></a></span><!-- 삭제 -->
			...
			<span class="btn_s"><a href="<c:url value='/cop/bbs/selectMnaRequest.do' /><c:if test='${boardMasterVO.cmmntyId != null}'>?cmmntyId=${boardMasterVO.cmmntyId}</c:if>"  title="<spring:message code="button.requestlist" /> <spring:message code="input.button" />"><spring:message code="button.requestlist" /></a></span><!-- 요청목록 -->
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
