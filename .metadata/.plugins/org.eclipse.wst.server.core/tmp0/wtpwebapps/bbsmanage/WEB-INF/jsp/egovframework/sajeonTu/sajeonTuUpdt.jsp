...
<!-- 상단타이틀  /cop/bbs/updateBBSMaster.do -->
 ...
 <div id="wTableFrm">
	...
	<tbody>
		...
		<c:set var="title"><spring:message code="comCopBbs.boardMasterVO.detail.day"/> </c:set>
			<th><label for="day">${title} </label></th>
			<td class="left">
			    <form:input path="day" title="${title} ${inputTxt }" size="70" maxlength="70"/>
