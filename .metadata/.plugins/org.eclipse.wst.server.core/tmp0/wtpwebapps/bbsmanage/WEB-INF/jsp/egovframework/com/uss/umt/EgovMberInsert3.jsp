...
function fnInsert(form){
	...
	alert('11 form.passwordCnsr.value='+form.passwordCnsr.value);
	alert('22 form.mberNm_S.value='+form.mberNm_S.value);
	alert('33 form.mberId_S.value='+form.mberId_S.value);*/
	if(form.passwordCnsr.value != form.passwordCnsrCk.value){
        alert("<spring:message code="fail.user.passwordCnsrCk" />");
        return false;
    }	
	...
	<tbody>
		...
		<tr>
			...
			<td class="left">
				...
				<c:out value='${boardMasterVO.replyPosblAt}'/> -->
		...
		<!-- <tr>
			...
			<td class="left">
                    <form:input path="bbsNm" title="${title} ${inputTxt}" size="50" maxlength="20" />
			...
			<tr>
				...
				<td class="left">
	                    <c:out value="${bbsNm_result.bbsNm}"/>
	                     <input type="hidden" name="bbsNm_S" value="<c:out value="${bbsNm_result.bbsNm}"/>" id="bbsNm_S" />	                    				                    	
	                    <input type="hidden" name="passwordCnsrCk" value="<c:out value="${bbsNm_result.passwordCnsrCk}"/>" id="passwordCnsrCk" />
		...
		<!-- <tr>
			<th><label for="bbsNm">${title}</label> <span class="pilsu">*</span></th>
			<td class="left">
				<form:password path="bbsNm" title="${title} ${inputTxt}" size="50" maxlength="20" />
				<div><form:errors path="bbsNm" cssClass="error" /></div> 
			</td>
		</tr> -->
		<%--<!-- 일반회원상태코드 -->
...
<!-- <input type="hidden" name="passwordCnsrCk" value="<c:out value='${passwordCnsrCk}'/>" id="passwordCnsrCk" /> -->
 <!-- 우편번호검색 -->
