...
function fn_egov_select_linkPage(pageNo){
	...
	document.BBSMasterForm.action = "<c:url value='/cop/bbs/selectSajeonSeon.do'/>";
...
<form name="BBSMasterForm" action="<c:url value='/cop/bbs/selectSajeonSeon.do'/>" method="post" onSubmit="fn_egov_search_bbssj(); return false;"> 
<div id="board">
<br>
	<h1>${pageTitle} <spring:message code="title.list" /></h1><!-- 투표소 목록 -->
	<!-- 하단 버튼 -->
	<div class="search_box" title="<spring:message code="common.searchCondition.msg" />">
		<ul><li><b>서울특별시=<font color="red">서울</b></font>, <b>경기도=<font color="red">경기</font>,인천광역시=<font color="red"><b>인천</font>,
	...
	<tr>
		...
		<th><spring:message code="table.day" /></th><!-- 사전투표 날짜 -->	
		...
		<%--<th><spring:message code="table.sajeonTuNo" /></th><!-- 사전투표소 번호 --> --%>
	...
	<tr>
		...
		<td class="left"><a href="<c:url value='/cop/bbs/updateSajeonTuView.do?no=${resultInfo.no}'/>"  >
		<center><c:out value='${resultInfo.tupyoso}'/></a></td>	
		<td class="left"><a href="<c:url value='/cop/bbs/updateSajeonTuView.do?no=${resultInfo.no}'/>"  >
		<center><c:out value='${resultInfo.day}'/></a></td>	
		<td class="left"><a href="<c:url value='/cop/bbs/updateSajeonTuView.do?no=${resultInfo.no}'/>"  >
