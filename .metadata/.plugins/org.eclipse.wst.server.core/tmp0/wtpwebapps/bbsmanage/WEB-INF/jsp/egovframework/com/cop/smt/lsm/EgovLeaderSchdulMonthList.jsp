...
<script type="text/javaScript" language="javascript">
	...
	******************************************************** */
	...
	function fnEgovSchdulSelect() {
		...
		var newLocation = "<c:url value='/cop/smt/lsm/usr/selectLeaderSchdulMonthList.do' />?year=<%=year%>&month=<%=month%>&searchCondition=register_id&searchKeyword=";
...
<body style="margin:0"> 
<form name="leaderSchdulVO" id="leaderSchdulVO" action="<c:url value='/cop/smt/lsm/usr/selectLeaderSchdulMonthList.do' />?year=<%=year%>&month=<%=month%>&searchCondition=register_id" method="post" target="_self">
